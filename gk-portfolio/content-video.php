...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div>
		...
		<div class="entry-summary">
			<?php the_excerpt(); ?>
			<a href="<?php echo get_permalink(get_the_ID()); ?>" class="readon"><?php _e('Read more', 'gk-portfolio'); ?></a>
		</div><!-- .entry-summary -->
		<?php else : ?>
		<div class="entry-content">
			<?php if($video_code != '') : ?>
				<?php echo str_replace($video_code, '', apply_filters('the_content', get_the_content( __( 'Read more', 'gk-portfolio' ) ))); ?>
