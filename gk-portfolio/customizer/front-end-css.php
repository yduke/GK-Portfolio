...
function portfolio_customizer_css() {
    ...
    <style type="text/css">
    	...
    	.site-main #page {
    		max-width: <?php echo esc_attr(get_theme_mod('portfolio_portfolio_width', '1260')); ?>px;
    	}
    	...
    	.search-no-results .page-content {
    		width: <?php echo esc_attr(get_theme_mod('portfolio_content_width', 700)); ?>px;
    	}
        ...
        .article-helper {
	        height: <?php echo esc_attr(get_theme_mod('portfolio_block_h', '380')); ?>px; 
        }
        ...
        .post-preview {
        	padding: <?php echo esc_attr(get_theme_mod('portfolio_block_padding', '56px 36px 36px 36px')); ?>;
        }
        ...
        @media (max-width: 1140px) {
        	...
        	.article-helper {
        		height: <?php echo esc_attr(get_theme_mod('portfolio_block_h_mobile', '320')); ?>px;
        	}
        	
        	.post-preview {
        		padding: <?php echo esc_attr(get_theme_mod('portfolio_block_padding_mobile', '20px 16px 36px 16px')); ?>;
        	}
        }
    </style>
    <?php   
