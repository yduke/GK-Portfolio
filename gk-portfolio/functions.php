...
if(!function_exists('portfolio_setup')) {
	...
	function portfolio_setup() {
		 ...
		 *
		 */
		load_theme_textdomain( 'gk-portfolio', get_template_directory() . '/languages' );
		...
		register_nav_menu('primary', __('Navigation Menu', 'gk-portfolio'));
		register_nav_menu('footer', __('Social Menu', 'gk-portfolio'));
...
if(!function_exists('portfolio_widgets_init')) {
	...
	function portfolio_widgets_init() {
		register_sidebar(array(
			'name'          => __( 'Bottom widget area', 'gk-portfolio' ),
			'id'            => 'bottom',
			'description'   => __( 'Appears at the bottom of the website.', 'gk-portfolio' ),
		...
		<nav class="navigation paging-navigation" role="navigation">
				<div class="nav-links">
					...
					<?php if (get_next_posts_link()) : ?>
						<div class="nav-previous"><?php next_posts_link( __( 'Older posts', 'gk-portfolio' ) ); ?></div>
					<?php endif; ?>
								
					<span class="pagination-item"><?php _e( 'Page', 'gk-portfolio' )?> <?php echo $paged ?> <?php _e( 'of', 'gk-portfolio' )?> <?php echo $wp_query->max_num_pages ?></span>			
		
					<?php if (get_previous_posts_link()) : ?>
						<div class="nav-next"><?php previous_posts_link( __( 'Newer posts', 'gk-portfolio' ) ); ?></div>
					<?php endif; ?>
...
if(!function_exists('portfolio_social_button')) {
	...
	function portfolio_social_button() {
		...
		if(!is_feed() && !is_home() && !is_page() && get_theme_mod('portfolio_post_show_social', '1') == '1') {
			...
			<span class="gk-social-label">'.__( 'Share:', 'gk-portfolio' ).'</span>
...
if(get_theme_mod('portfolio_special_img_size', '0') == '1') {
	if(!function_exists('portfolio_image_sizes')) {
		...
		function portfolio_image_sizes($sizes) {
			$addsizes = array(
				"gk-portfolio-size" => __( "Portfolio image", "gk-portfolio")
			);
	...
	add_image_size('gk-portfolio-size', get_theme_mod('portfolio_img_w', 500), get_theme_mod('portfolio_img_h', 375), get_theme_mod('portfolio_img_hard_crop', '1') == '1');
